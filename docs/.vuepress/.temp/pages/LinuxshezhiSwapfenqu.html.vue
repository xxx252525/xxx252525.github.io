...
<p>Swap分区是什么？Linux中Swap（即：<a href="https://www.vpsgo.com/tag/%E4%BA%A4%E6%8D%A2%E5%88%86%E5%8C%BA" target="_blank" rel="noopener noreferrer">交换分区<ExternalLinkIcon/></a>），类似于Windows的虚拟内存，就是当内存不足的时候，把一部分硬盘空间虚拟成内存使用，从而解决内存容量不足的情况。</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果我们Swap分区设置的不合理（太小），并且VPS本身的物理内存也不够用，那么就会出现<a href="https://www.vpsgo.com/tag/linux-swap%E5%8D%A0%E7%94%A8%E5%BE%88%E9%AB%98" target="_blank" rel="noopener noreferrer">Linux Swap占用很高<ExternalLinkIcon/></a>，甚至Swap分区全部占满的情况，一般来说，根据Linux内存的大小不同，我们可以按照下面的对应关系设置<a href="https://www.vpsgo.com/tag/swap%E5%88%86%E5%8C%BA%E5%A4%A7%E5%B0%8F" target="_blank" rel="noopener noreferrer">Swap分区大小<ExternalLinkIcon/></a>：</p>
<ol>
