...
highlights:
  - header: 天阁创客official的三味书屋
    ...
    features:
      ...
      - title: Android
        icon: /assets/icon/AndroidStudio.svg
        details: 全球最大的开源移动端操作系统
        link: https://theme-hope.vuejs.press/zh/guide/markdown/chart/chartjs.html

      - title: Kotlin
        icon: /assets/icon/kotlin.svg
        details: 在Java虚拟机运行，用于Android开发的语言
  ...
  - header: 网络安全专区
    ...
    highlights:
      - title: 渗透测试
        icon: /assets/icon/网络安全.svg
        details: 探索安全边界，守护网络安全，渗透测试先行。
        link: https://theme-hope.vuejs.press/zh/guide/layout/navbar.html

      - title: SRC漏洞挖掘
        icon: /assets/icon/SRC.svg
        details: 挖掘潜在风险，守护企业安全，SRC漏洞挖掘。
