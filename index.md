...
![image-20241025163217689](./index.assets/image-20241025163217689.png)

下载好之后双击无脑安装在默认位置即可，默认位置如下：C:\Program Files\Java

![image-20241025163712026](./index.assets/image-20241025163712026.png)

然后配置系统环境变量，(点击Windows下面的搜索-->高级设置-->点击环境变量-->)

<img src="./index.assets/image-20241025162454356.png" alt="image-20241025162454356" style="zoom: 80%;" />

<img src="./index.assets/image-20241025162528468.png" alt="image-20241025162528468" style="zoom:80%;" />

然后在高级系统设置里面添加环境变量：![image-20241025163810060](./index.assets/image-20241025163810060.png)
...
<img src="./index.assets/image-20241025152136998.png" alt="image-20241025152136998" style="zoom: 50%;" />
...
![image-20241025161749168](./index.assets/image-20241025161749168.png)
...
![image-20241025161919339](./index.assets/image-20241025161919339.png)

同时我们还需要下载一些SDK依赖和工具，勾选以下内容：

![image-20241025162032095](./index.assets/image-20241025162032095.png)

![image-20241025162056726](./index.assets/image-20241025162056726.png)
...
![image-20241025162312140](./index.assets/image-20241025162312140.png)

下载好之后将其解压到自己设置好的目录下面：

<img src="./index.assets/image-20241025162401210.png" alt="image-20241025162401210" style="zoom:80%;" />
...
<img src="./index.assets/image-20241025162621068.png" alt="image-20241025162621068" style="zoom:80%;" />

然后创建一个目录用于存放maven和gradle下载的文件等：

![image-20241025162810443](./index.assets/image-20241025162810443.png)

创建环境变量：

![image-20241025162916986](./index.assets/image-20241025162916986.png)

去AndroidStudio中配置gradle的夏至位置：

![image-20241025163035541](./index.assets/image-20241025163035541.png)
...
![image-20241025165204865](./index.assets/image-20241025165204865.png)
...
![image-20241025164224592](./index.assets/image-20241025164224592.png)

我们选择第二个效果如下：

![image-20241025164430167](./index.assets/image-20241025164430167.png)

第一个效果如下：

![image-20241025164516849](./index.assets/image-20241025164516849.png)
...
<img src="./index.assets/image-20241025200955438.png" alt="image-20241025200955438" style="zoom:80%;" />
...
<img src="./index.assets/image-20241025201249666.png" alt="image-20241025201249666" style="zoom:80%;" />

project项目目录：

<img src="./index.assets/image-20241028160641307.png" alt="image-20241028160641307" style="zoom:80%;" />
...
<img src="./index.assets/image-20241028101027284.png" alt="image-20241028101027284" style="zoom:80%;" />
...
![image-20241028103924489](./index.assets/image-20241028103924489.png)
...
![image-20241028104348553](./index.assets/image-20241028104348553.png)

我们被定义的样式内容如下：

![image-20241028104511878](./index.assets/image-20241028104511878.png)
...
![image-20241028104913042](./index.assets/image-20241028104913042.png)
...
![image-20241028144352221](./index.assets/image-20241028144352221.png)

如果属性的值为false，他还是会进行显示，只不过会堆叠到左上角而已。注意：左对齐和顶部对齐的显示效果是一样的如图：

![image-20241028144526552](./index.assets/image-20241028144526552.png)
...
![image-20241028150642667](./index.assets/image-20241028150642667.png)
...
![image-20241028151754212](./index.assets/image-20241028151754212.png)

![image-20241028151827757](./index.assets/image-20241028151827757.png)

![image-20241028151937814](./index.assets/image-20241028151937814.png)
...
我们只需要在属性的值内天上对应的参照物为值即可：![image-20241028152345795](./index.assets/image-20241028152345795.png)
...
![image-20241028152514913](./index.assets/image-20241028152514913.png)

![image-20241028145132356](./index.assets/image-20241028145132356.png)
...
![image-20241028155950316](./index.assets/image-20241028155950316.png)
...
<img src="./index.assets/image-20241106194648830.png" alt="image-20241106194648830" style="zoom:80%;" />
...
<img src="./index.assets/image-20241106195132271.png" alt="image-20241106195132271" style="zoom: 67%;" />
...
<img src="./index.assets/image-20241106210126010.png" alt="image-20241106210126010" style="zoom: 67%;" />
...
<img src="./index.assets/image-20241106165936971.png" alt="image-20241106165936971" style="zoom: 67%;" />
...
<img src="./index.assets/image-20241108211141270.png" alt="image-20241108211141270" style="zoom:55%;" />

然后我们在layout主文件中引入了我们自己写的title，我们使用`include`标签来实现导入自己编写的xml文件。

**`include`标签就是用来导入文件配置的，自己编写的布局可以进行导入。**

<img src="./index.assets/image-20241108211404313.png" alt="image-20241108211404313" style="zoom:57%;" />
...
![image-20241028175027648](./index.assets/image-20241028175027648.png)

稳重的@string的用法如下，我们在res目录中有一个value目录，里面存放着一些参数值xml文件，可以用来传参调用：

![image-20241028175622618](./index.assets/image-20241028175622618.png)

当文本信息框内容显示不完全，并且不在显示需要省略的时候，我们只需要使用`android:ellipsize="end"`进行结束即可，效果如下：

![image-20241028175915048](./index.assets/image-20241028175915048.png)

如果我们不想显示那么多行数信息，我们可以使用`android:maxLines`来显示最大行数，但是和lines不能同事使用，否则就会以lines为主，lines的优先级比maxlines更高。例如：

![image-20241028180512167](./index.assets/image-20241028180512167.png)
...
![image-20241028182034071](./index.assets/image-20241028182034071.png)
...
![image-20241029101015380](./index.assets/image-20241029101015380.png)
...
<img src="./index.assets/image-20241029102911479.png" alt="image-20241029102911479" style="zoom:80%;" />
...
<img src="./index.assets/image-20241029103538449.png" alt="image-20241029103538449" style="zoom: 60%;" />
...
<img src="./index.assets/image-20241029103950871.png" alt="image-20241029103950871" style="zoom:60%;" />
...
![image-20241029105210706](./index.assets/image-20241029105210706.png)
...
<img src="./index.assets/image-20241029105625653.png" alt="image-20241029105625653" style="zoom: 60%;" />
...
![image-20241029110742292](./index.assets/image-20241029110742292.png)
...
<img src="./index.assets/image-20241029112217614.png" alt="image-20241029112217614" style="zoom:60%;" />
...
<img src="./index.assets/image-20241029112701943.png" alt="image-20241029112701943" style="zoom:60%;" />
...
![image-20241029160905170](./index.assets/image-20241029160905170.png)
...
我们通过使用RadioGroup和RadioButton实现了一个单选项目，选择不同的语言：![image-20241029205915258](./index.assets/image-20241029205915258.png)
...
![image-20241029210143863](./index.assets/image-20241029210143863.png)
...
![image-20241029214302399](./index.assets/image-20241029214302399.png)
...
<img src="./index.assets/image-20241029213635284.png" alt="image-20241029213635284" style="zoom:60%;" />

对应的日志信息如下：

![image-20241029213707187](./index.assets/image-20241029213707187.png)
...
<img src="./index.assets/image-20241106213901873.png" alt="image-20241106213901873" style="zoom:80%;" />
...
<img src="./index.assets/image-20241106214139391.png" alt="image-20241106214139391" style="zoom:67%;" />
...
<img src="./index.assets/image-20241106215417243.png" alt="image-20241106215417243" style="zoom:80%;" />
...
![image-20241030101418579](./index.assets/image-20241030101418579.png)

对话提示如下：

<img src="./index.assets/image-20241030101403912.png" alt="image-20241030101403912" style="zoom:60%;" />
...
<img src="./index.assets/image-20241030102008308.png" alt="image-20241030102008308" style="zoom:60%;" />

#### 单选对话框

除了常见的布尔值对话框，还有单元对话框和多选对话框，我们这里讲解下单选对话框，我们依然是在Java中写交互逻辑，我们修改以下XML的onClick的值：

<img src="./index.assets/image-20241030104619426.png" alt="image-20241030104619426"  />
...
<img src="./index.assets/image-20241030104011374.png" alt="image-20241030104011374" style="zoom:60%;" />
...
<img src="./index.assets/image-20241030110751719.png" alt="image-20241030110751719" style="zoom: 67%;" />

我们的操作也日志记录如下：

![image-20241030110846636](./index.assets/image-20241030110846636.png)
...
![image-20241030170929959](./index.assets/image-20241030170929959.png)
...
![image-20241031110526443](./index.assets/image-20241031110526443.png)

然后我们需要在layout目录下编写单独的列表文件，内容和原来ListView的有一点点变化，如下：

![image-20241031112303130](./index.assets/image-20241031112303130.png)
...
<img src="./index.assets/image-20241031151936837.png" alt="image-20241031151936837" style="zoom:70%;" />
...
<img src="./index.assets/image-20241106225238865.png" alt="image-20241106225238865" style="zoom:80%;" />
...
![image-20241110174004853](./index.assets/image-20241110174004853.png)

圆形的渐变色：

![image-20241110174226273](./index.assets/image-20241110174226273.png)
...
![image-20241110182256296](./index.assets/image-20241110182256296.png)

运行效果如下：

![image-20241110182019569](./index.assets/image-20241110182019569.png)
...
<img src="./index.assets/image-20241031152201833.png" alt="image-20241031152201833" style="zoom:80%;" />

然后选择APK，点击下一步：

<img src="./index.assets/image-20241031152406149.png" alt="image-20241031152406149" style="zoom:80%;" />

接着我们需要创建一个key：

<img src="./index.assets/image-20241031152434106.png" alt="image-20241031152434106" style="zoom:80%;" />

然后配置Key：

<img src="./index.assets/image-20241031152622768.png" alt="image-20241031152622768" style="zoom:80%;" />

后面这个地方我们设置密码的时候和上面的密码1是一样的：

<img src="./index.assets/image-20241031152736973.png" alt="image-20241031152736973" style="zoom:80%;" />
...
<img src="./index.assets/image-20241031153003912.png" alt="image-20241031153003912" style="zoom:80%;" />

动图会弹出代理，我们取消掉不用管【前提是必须打开VPN挂代理】：

<img src="./index.assets/image-20241031153137878.png" alt="image-20241031153137878" style="zoom:75%;" />

然后点击Modules：

<img src="./index.assets/image-20241031153406672.png" alt="image-20241031153406672" style="zoom:75%;" />

如果你编译的时候，你的系统版本是安卓老版本，那么你需要修改以下配置：

<img src="./index.assets/image-20241031153650465.png" alt="image-20241031153650465" style="zoom:75%;" />

选项的内容如下：

![image-20241031153711033](./index.assets/image-20241031153711033.png)

然后我们需要点击SIgning Config创建一个release版本，做出如下配置：

<img src="./index.assets/image-20241031153855210.png" alt="image-20241031153855210" style="zoom:75%;" />

最后修改创建的类型：

<img src="./index.assets/image-20241031154006576.png" alt="image-20241031154006576" style="zoom:75%;" />

这样我们在默认编译的时候就会选择release的版本来进行编译，我们可以通过一种方式来查看是否切换到了release版本，如果没有切换，我们手动切换即可：

点击

<img src="./index.assets/image-20241031154413982.png" alt="image-20241031154413982" style="zoom:80%;" />

然后左下角会多出来一个`build variants`：

<img src="./index.assets/image-20241031154447338.png" alt="image-20241031154447338" style="zoom:80%;" />
...
<img src="./index.assets/image-20241031154726006.png" alt="image-20241031154726006" style="zoom:80%;" />

选择release：

<img src="./index.assets/image-20241031154739772.png" alt="image-20241031154739772" style="zoom:80%;" />

最后点击创建即可，编译打包APK中：

<img src="./index.assets/image-20241031154823361.png" alt="image-20241031154823361" style="zoom:80%;" />

打包完成之后，目录里面会多一个release目录，里面存放在我们变异好的apk：

<img src="./index.assets/image-20241031154913945.png" alt="image-20241031154913945" style="zoom:80%;" />
...
![image-20241108205456800](./index.assets/image-20241108205456800.png)

然后重启软件下载SDK或者点击文件上面的：

![image-20241108205544551](./index.assets/image-20241108205544551.png)

我们将版本修改成了Android12，成功的在Android12的手机上运行了起来：

<img src="./index.assets/image-20241108210113090.png" alt="image-20241108210113090" style="zoom:60%;" />

我们如果要在Android9上面跑修改以下即可：

![image-20241108210220493](./index.assets/image-20241108210220493.png)

运行如图：

<img src="./index.assets/image-20241108210515451.png" alt="image-20241108210515451" style="zoom:67%;" />

我们的软件是可以上下兼容到最高的Android13，因为我们`targetSdk`的值是34，34代表的是Android13，我们的软件可以在Android9~Android13这个环境下运行。如图：

![image-20241108210816275](./index.assets/image-20241108210816275.png)
