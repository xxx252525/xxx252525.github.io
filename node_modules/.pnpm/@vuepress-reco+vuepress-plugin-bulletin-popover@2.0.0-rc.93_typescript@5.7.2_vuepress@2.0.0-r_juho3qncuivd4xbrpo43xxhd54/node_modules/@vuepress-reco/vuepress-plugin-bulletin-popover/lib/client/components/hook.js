...
function useThemeLocaleData() {
    ...
    const routeLocale = computed(() => resolveLocalePath(themeConfig.locales || {}, route?.path || '/'));
    const themeLocaleData = computed(() => resolveThemeLocaleData(themeConfig, routeLocale.value));
