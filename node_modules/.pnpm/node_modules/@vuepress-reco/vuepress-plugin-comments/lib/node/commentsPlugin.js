...
export const commentsPlugin = (themeConfig) => {
    return {
        ...
        onGenerated: (app) => {
            ...
            if (styleFileName) {
                try {
                    ...
                    const giscusThemeDark = content.substring(darkdarkIndexStart, darkIndexEnd + 26);
                    ...
                    console.error('[THEME RECO ERROR] ', 'an error occurred while processing the style of giscus', error);
                }
            }
        },
        define: () => ({
