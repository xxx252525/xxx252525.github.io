...
export declare const inferLocaleLang: (localePath?: string, debug?: boolean) => KnownLangCode;
/** Infer locale path from language */
export declare const inferLocalePath: (lang?: string, debug?: boolean) => string;
/**
 ...
 */
export declare const inferRootLocalePath: (app: App) => string;
/**
 * Get locale paths
 *
 * @param app VuePress Node app
